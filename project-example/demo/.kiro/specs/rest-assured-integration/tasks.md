...
- [x] 1. Add REST Assured dependencies and test configuration
  - [x] 1.1 Add REST Assured test dependencies to build.gradle.kts
  ...
  - [x] 1.2 Create test.properties for H2 datasource configuration
...
- [x] 2. Implement base test infrastructure
  - [x] 2.1 Create BaseIntegrationTest abstract class
...
- [x] 4. Implement User endpoint integration tests
  - [x] 4.1 Create UserControllerIT — registration tests
  ...
  - [x] 4.2 Create UserControllerIT — login tests
...
- [x] 5. Checkpoint - Verify user endpoint tests pass
  - Ensure all tests pass with `./gradlew test`, ask the user if questions arise.

- [x] 6. Implement Book CRUD integration tests — Create and Read
  - [x] 6.1 Create BookControllerIT — book creation tests
  ...
  - [x] 6.2 Add BookControllerIT — book read tests
...
- [x] 7. Implement Book CRUD integration tests — Update and Delete
  - [x] 7.1 Add BookControllerIT — book update tests
  ...
  - [x] 7.2 Add BookControllerIT — book delete tests
...
- [x] 8. Implement authentication enforcement integration tests
  - [x] 8.1 Create AuthInterceptorIT
...
- [x] 9. Final checkpoint - Ensure all integration tests pass
