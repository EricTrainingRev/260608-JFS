...
public class User {
  ...
  @GeneratedValue(
      strategy = GenerationType.UUID) // indicates the value should be generated by the db
  private UUID id;

  @Column(
      nullable = false,
      unique = true) // tells Spring to make the username column unique and not nullable
