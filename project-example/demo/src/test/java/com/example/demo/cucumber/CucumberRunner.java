...
@IncludeEngines(
    "cucumber") // This tells Junit to let Cucumber facilitate the tests associated with this class
@SelectPackages({
  "features",
  "com.example.demo.cucumber"
}) // This tells junit to include the features directory of "resources" and the steps package as
// part of the suite
@ConfigurationParameter(
    key = GLUE_PROPERTY_NAME,
    value = "com.example.demo.cucumber") // This tells CUCUMBER where the code associated with the
// acceptance criteria is located
@ConfigurationParameter(
    key = PLUGIN_PROPERTY_NAME,
    value =
        "html:reports/cucumber-report.html") // This tells Cucumber to create an html test report
@CucumberContextConfiguration // This tells Spring to manage dependency injection for Cucumber
@SpringBootTest(
    webEnvironment =
        SpringBootTest.WebEnvironment
            .DEFINED_PORT) // spins up the application web server for testing
@TestPropertySource(
    locations = "classpath:test.properties") // tells Spring to use our test properties
